...
def atest_login_and_logout(login_model, debug_model, selenium):
	debug_model.switch_to_int(selenium)
...
def test_profile_about_version_check(debug_model, profile_model, selenium):
	debug_model.switch_to_int_version_check(selenium)
...
def aOLDtest_self_question_comment_edit_and_delete_second(debug_model, login_model, post_model, selenium):
	debug_model.switch_to_int(selenium)
	login_model.login_only(selenium)
	post_model.ask_question(selenium)
