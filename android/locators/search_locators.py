...
FIRST_ITEM_NAME_SEARCH = "//androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[1]/android.widget.TextView[1]" #"//androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[1]/android.widget.TextView[1]"
...
SEARCH_RESULT_ONE_ITEM_TEXT = "com.socialsuperstore:id/centeredTitleText" #"com.socialsuperstore:id/titleText" 	
